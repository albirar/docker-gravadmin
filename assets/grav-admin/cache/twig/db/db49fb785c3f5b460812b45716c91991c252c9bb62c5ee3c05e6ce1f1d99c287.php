...
class __TwigTemplate_d27b59f2ab0783f40b31ddbb6d52b858051ba700ba616584aa61f6f2790d2a87 extends \Twig\Template
{
...
";
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["header"] ?? null), "resume", []), "about", []), "general_info", [])) {
            // line 21
            echo "                  <p>";
            echo $this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->markdownFunction($context, $this->getAttribute($this->getAttribute($this->getAttribute(($context["header"] ?? null), "resume", []), "about", []), "general_info", []));
            echo "</p>
";
        }
        // line 23
...
";
    ...
    {
        return new Source("", "partials/about.html.twig", "/var/www/html/user/themes/brilliant-resume/templates/partials/about.html.twig");
    }
}
